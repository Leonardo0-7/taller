...
public class CuentaBancaria {
    ...
    public static void main(String[] args) {
        ...
        CuentaBancaria cuenta2 = new CuentaBancaria("100489772", "Credito");
        cuenta2.mostrarDetalles(); 

        CuentaBancaria cuenta3 = new CuentaBancaria("791972571", 166800.0, "Ahorros");
